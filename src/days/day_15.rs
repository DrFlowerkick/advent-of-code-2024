...
mod tests {
    ...
    // taken from ../../assets/day_15_example_01.txt
    const S: usize = 8;
    // taken from ../../assets/day_15_example_02.txt
    const B: usize = 10;
    const T: usize = 20;

    #[test]
    fn test_example_part() -> Result<()> {
        let example_01 = include_str!("../../assets/day_15_example_01.txt");
        let example_02 = include_str!("../../assets/day_15_example_02.txt");
        ...
        let example_03 = include_str!("../../assets/day_15_example_03.txt");
