...
// value taken from ../../assets/day_12.txt
const N: usize = 140;
...
mod tests {
    ...
    use super::*;
    // value taken from ../../assets/day_12_example.txt
    const E: usize = 10;
    const S: usize = 6;

    #[test]
    fn test_example_part() -> Result<()> {
        let input = include_str!("../../assets/day_12_example_01.txt");
        ...
        let input = include_str!("../../assets/day_12_example_02.txt");
